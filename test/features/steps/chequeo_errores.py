...
def step_impl(context):
    legajo = 1
    registro = 99999
    context.response = requests.get(f"{BASE_URL}/recursos/{legajo}/registros/{registro}")
...
def step_impl(context):
    ...
    context.response = requests.post(f"{BASE_URL}/recursos/{legajo}/registros", json=registro)
...
def step_impl(context):
    ...
    context.response = requests.get(f"{BASE_URL}/recursos/registros", params=params)